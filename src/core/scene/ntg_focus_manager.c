...
// /* -------------------------------------------------------------------------- */
// 
// static void scope_stack_pop(ntg_scene* scene);
// 
// // Pops from the stack until the function finds valid scope
// static void scope_stack_sync(ntg_scene* scene);
// 
// static void 
...
//     };
// 
//     ntg_scene_scope_stack_push(scene, &scope);
// }
// 
...
//     if(scene->__scope_stack->size < 2)
//         return;
// 
//     scope_stack_pop(scene);
// 
//     scope_stack_sync(scene);
// }
// 
...
//     ntg_scene_mark_dirty(scene);
// 
//     struct ntg_scene_scope_list_node* it_node = scene->__scope_stack->head;
//     struct ntg_scene_scope_data* it_data;
// 
//     while(it_node)
//     {
//         it_data = it_node->data;
// 
//         if(ntg_object_is_descendant_eq(it_data->scope.root, object))
//             it_data->valid = false;
// 
...
// {
//     int _status;
//     ntg_scene_scope_list_popf(scene->__scope_stack, &_status);
//     assert(_status == GENC_SUCCESS);
// 
//     struct ntg_scene_scope_list_node* head = scene->__scope_stack->head;
//     assert(head);
// 
//     ntg_scene_request_focus(scene, head->data->last_focused);
// 
...
// static void scope_stack_sync(ntg_scene* scene)
// {
//     struct ntg_scene_scope_list_node* head;
// 
//     while(true)
//     {
//         head = scene->__scope_stack->head;
// 
//         if(!head->data->valid)
//             scope_stack_pop(scene);
//         else
