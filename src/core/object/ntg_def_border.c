...
//         const ntg_def_border* border,
//         struct ntg_xy size,
//         ntg_tmp_object_drawing* out_drawing);
// 
// static void draw_north(
//         const ntg_def_border* border,
//         struct ntg_xy size,
//         struct ntg_xy child_start,
//         struct ntg_xy child_size,
...
//     border->_style = style;
// 
//     ntg_object_add_dirty((ntg_object*)border, NTG_OBJECT_DIRTY_DRAW);
// }
// 
// /* ------------------------------------------------------ */
// /* PRESETS */
...
//         for(j = 0; j < size.x; j++)
//         {
//             it_cell = ntg_tmp_object_drawing_get_(out_drawing, ntg_xy(j, i));
...
//         {
//             it_cell = ntg_tmp_object_drawing_get_(out_drawing, ntg_xy(0, 0));
//             (*it_cell) = border->_style.top_left;
// 
//             for(j = 1; j < (size.x - 1); j++)
//             {
//                 it_cell = ntg_tmp_object_drawing_get_(out_drawing, ntg_xy(j, 0));
//                 (*it_cell) = border->_style.top;
//             }
// 
//             it_cell = ntg_tmp_object_drawing_get_(out_drawing, ntg_xy(size.x - 1, 0));
...
//             for(i = 0; i < size.y; i++)
//             {
//                 it_cell = ntg_tmp_object_drawing_get_(out_drawing, ntg_xy(size.x - 1, i));
...
//         {
//             it_cell = ntg_tmp_object_drawing_get_(out_drawing, ntg_xy(0, size.y - 1));
//             (*it_cell) = border->_style.bottom_left;
// 
//             for(j = 1; j < (size.x - 1); j++)
//             {
//                 it_cell = ntg_tmp_object_drawing_get_(out_drawing, ntg_xy(j, size.y - 1));
//                 (*it_cell) = border->_style.top;
//             }
// 
//             it_cell = ntg_tmp_object_drawing_get_(out_drawing, ntg_xy(size.x - 1, size.y - 1));
...
//             for(i = 0; i < size.y; i++)
//             {
//                 it_cell = ntg_tmp_object_drawing_get_(out_drawing, ntg_xy(0, i));
