...
//     north_opts.palign = NTG_LABEL_TEXT_ALIGN_JUSTIFY;
...
//     center_opts.orient = NTG_ORIENT_V;
//     center_opts.palign = NTG_ALIGN_2;
//     center_opts.salign = NTG_ALIGN_2;
...
//     south_opts.orient = NTG_ORIENT_H;
//     south_opts.palign = NTG_ALIGN_2;
//     south_opts.salign = NTG_ALIGN_2;
