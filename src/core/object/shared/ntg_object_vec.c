...
void ntg_object_vec_add(ntg_object_vec* vec, ntg_object* object)
{
    ...
    ntg_vec_add((ntg_vec*)vec, &object, sizeof(ntg_object*));
}
...
void ntg_object_vec_rm(ntg_object_vec* vec, ntg_object* object)
{
    ...
    ntg_vec_rm((ntg_vec*)vec, &object, NULL, sizeof(ntg_object*));
}
        ...
        const ntg_object* object)
{
    ...
    return ntg_vec_find((ntg_vec*)vec, &object, NULL, sizeof(ntg_object*));
}
...
void ntg_const_object_vec_init(ntg_const_object_vec* vec)
{
    ...
    ntg_vec_init((ntg_vec*)vec, sizeof(const ntg_object* const), 5, sizeof(ntg_object*));
}
