...
static struct ntg_measure_out __ntg_box_measure_content(
        const ntg_box* box,
        ...
        sarena* arena)
{
    ...
    return __ntg_box_measure_content(box, orientation, ctx);
}
        ...
        sarena* arena)
{
    ...
    struct ntg_measure_out content_size = __ntg_box_measure_content(
