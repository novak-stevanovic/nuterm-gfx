...
//         size_t for_size, sarena* arena);
// 
// static size_t get_wrap_rows_nowrap(
//         const struct ntg_strv_utf32 row,
//         size_t for_size,
//         struct ntg_strv_utf32** out_wrap_rows,
//         sarena* arena);
// 
// static size_t get_wrap_rows_wrap(
//         const struct ntg_strv_utf32 row,
//         size_t for_size,
//         struct ntg_strv_utf32** out_wrap_rows,
//         sarena* arena);
// 
// static size_t get_wrap_rows_wwrap(
//         const struct ntg_strv_utf32 row,
//         size_t for_size,
//         struct ntg_strv_utf32** out_wrap_rows,
//         sarena* arena);
...
//             for(j = 0; j < cont_size.x; j++)
//             {
//                 it_cell = ntg_tmp_object_drawing_get_(out_drawing, ntg_xy(i, j));
//                 it_cont = &(cont_buff[cont_size.x * i + j]);
// 
//                 (*it_cell) = ntg_vcell_full((*it_cont), label->_opts.gfx);
//             }
