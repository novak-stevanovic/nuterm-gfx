...
#define NTG_ERR_RENDER_FAIL (NTG_ERROR_BASE + 202)
#define NTG_ERR_TASK_RUNNER_ACTIVE (NTG_ERROR_BASE + 203)
#define NTG_ERR_TASK_RUNNER_CANCELLED (NTG_ERROR_BASE + 204)
